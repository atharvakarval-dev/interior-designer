...
export function Projects() {
  return (
    <section id="projects" className="bg-[#e8e8e8] px-6 py-24 lg:px-12 lg:py-32 w-full">
      <div className="container mx-auto max-w-[1200px]">
        <div className="mb-16 flex flex-col justify-between gap-8 md:flex-row md:items-end lg:mb-24">
          ...
          <FadeUp delay={0.2}>
            <a
              href="#contact"
              className="inline-flex items-center justify-center rounded-full border border-black px-[20px] py-[16px] text-[16px] font-normal text-black transition-colors hover:bg-black hover:text-white"
            >
              View all projects
            </a>
          </FadeUp>
